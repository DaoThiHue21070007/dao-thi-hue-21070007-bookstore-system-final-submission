...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference("Placement.count") do
      post placements_url, params: { placement: { name: @placement.name, placement: @placement.placement } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { name: @placement.name, placement: @placement.placement } }
