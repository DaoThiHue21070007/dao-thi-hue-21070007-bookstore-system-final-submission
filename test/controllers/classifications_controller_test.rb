...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference("Classification.count") do
      post classifications_url, params: { classification: { Description: @classification.Description, Name: @classification.Name } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { Description: @classification.Description, Name: @classification.Name } }
